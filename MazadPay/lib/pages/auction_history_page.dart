...
class AuctionHistoryPage extends ConsumerWidget {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${auction.currentPrice.toStringAsFixed(0)} أوقية جديدة',
                  style: TextStyle(
                    fontFamily: 'Plus Jakarta Sans',
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                ...
                Text(
                  AppLocalizations.of(context)!.text_76,
                  style: TextStyle(
                    fontFamily: 'Plus Jakarta Sans',
                    fontSize: 12,
                    color: Colors.grey,
  ...
  Widget _buildSummaryHeader(BuildContext context, bool isDarkMode) {
    return Column(
      ...
      children: [
        Text(
          AppLocalizations.of(context)!.text_77,
          style: TextStyle(
            fontFamily: 'Plus Jakarta Sans',
            fontSize: 16,
            fontWeight: FontWeight.bold,
        ...
        _buildSummaryRow(
          AppLocalizations.of(context)!.text_79,
          '12',
          isDarkMode,
        ),
      ],
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          '${bid.amount.toStringAsFixed(0)} أوقية',
                          style: TextStyle(
                            fontFamily: 'Plus Jakarta Sans',
                            fontWeight: FontWeight.bold,
                            fontSize: 15,
                    ...
                    const SizedBox(height: 4),
                    Text(
                      '${bid.bidderName} (${bid.phoneNumber})',
                      style: TextStyle(
                        fontFamily: 'Plus Jakarta Sans',
                        color: Colors.grey,
                        fontSize: 12,
