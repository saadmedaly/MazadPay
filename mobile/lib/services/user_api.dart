...
class UserApi {
  ...
  Future<ApiResponse<Map<String, dynamic>>> getUserSettings() async {
    try {
      final response = await _apiService.get<Map<String, dynamic>>('/users/me/settings');
      return ApiResponse<Map<String, dynamic>>.fromJson(response);
    } catch (e) {
      return ApiResponse.error(e.toString());
    }
  ...
  Future<ApiResponse<Map<String, dynamic>>> updateUserSettings(Map<String, dynamic> settings) async {
    try {
      final response = await _apiService.put<Map<String, dynamic>>(
        '/users/me/settings',
        data: settings,
