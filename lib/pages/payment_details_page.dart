                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final assets = [
                        'corolla.png', 'house.png', 'iphone.png', 
                        'laptop.png', 'raf4.png', 'smaah.png',
                        'on1.png', 'on2.png', 'on3.png',
                        'announcement.png', 'logo.png', 'Bankily.png',
                        'Click.png', 'Masrivi.png', 'Sedad.png'
                      ];
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 15),
                  // MazadPay Logo
                  Image.asset('logo.png', height: 40, width: 100, fit: BoxFit.contain, errorBuilder: (c, e, s) => const Text('MazadPay')),
                ],
              ),
